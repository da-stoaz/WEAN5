        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center gap-3">
                    <img src="{{ asset('HPMS.png') }}" alt="HPMS Logo" class="h-15 w-auto object-contain">
                ...
                <div class="flex items-center">
                    <a href="{{-- route('items.create') --}}"
                        class="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium text-white transition-colors duration-200 bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none shadow-sm">
